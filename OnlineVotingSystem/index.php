...
<style>
        ...
        .logo {
            ...
            margin-top: 10px;
            margin-left: 10px;
            width: auto; /* Increase width to stretch the logo */
        ...
        .college-name {
            ...
            background-color: #333; /* Add background color to the box */
...
<body>
<img src="https://tse2.mm.bing.net/th?id=OIP.6NIiX2R7q28OjQ54gHQqtwAAAA&pid=Api&P=0&h=220" alt="College Logo" class="logo">
